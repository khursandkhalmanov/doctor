			...
			<div class="row">
				<div class="col-12">
					...
					<div class="card">
						<div class="card-body">
							<div class="booking-doc-info">
								<a href="doctor-profile.blade.php" class="booking-doc-img">
									<img src="assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
								</a>
								<div class="booking-info">
									<h4><a href="doctor-profile.blade.php">Dr. Darren Elder</a></h4>
									<div class="rating">
					...
					<div class="submit-section proceed-btn text-right">
						<a href="checkout.blade.php" class="btn btn-primary submit-btn">Proceed to Pay</a>
					</div>
					<!-- /Submit Section -->
