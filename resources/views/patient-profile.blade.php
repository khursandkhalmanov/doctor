											...
											<div class="table-responsive">
												<table class="table table-hover table-center mb-0">
													...
													<tr>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
																	<img class="avatar-img rounded-circle" src="assets/img/doctors/doctor-thumb-02.jpg" alt="User Image">
																</a>
																<a href="doctor-profile.blade.php">Dr. Darren Elder <span>Dental</span></a>
															</h2>
														</td>
													...
													<tr>
														...
														<td class="text-right">
															<div class="table-action">
																<a href="edit-prescription.blade.php" class="btn btn-sm bg-success-light">
																	<i class="far fa-edit"></i> Edit
																</a>
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Ruby Perrin <span>Dental</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Deborah Angel <span>Cardiology</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Sofia Brient <span>Urology</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Marvin Campbell <span>Dental</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Katharine Berthold <span>Orthopaedics</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Linda Tobin <span>Neurology</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Paul Richard <span>Dermatology</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. John Gibbs <span>Dental</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Olga Barlow <span>Dental</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
													...
													<tr>
														...
														<td class="text-right">
															<div class="table-action">
																...
																<a href="edit-prescription.blade.php" class="btn btn-sm bg-success-light" data-toggle="modal" data-target="#add_medical_records">
																	<i class="fas fa-edit"></i> Edit
																</a>
																<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																	<i class="far fa-trash-alt"></i> Delete
													...
													<tr>
														...
														<td>
															<h2 class="table-avatar">
																...
																<a href="doctor-profile.blade.php">Dr. Marvin Campbell <span>Ophthalmology</span></a>
															</h2>
														</td>
														<td class="text-right">
															<div class="table-action">
										...
										<div class="card-body">
											<div class="table-responsive">
												...
												<table class="table table-hover table-center mb-0">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0010</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
																...
																<a href="doctor-profile.blade.php">Ruby Perrin <span>Dental</span></a>
															</h2>
														</td>
														<td>$450</td>
														<td>14 Nov 2019</td>
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0009</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
														...
														<td class="text-right">
															<div class="table-action">
																...
																<a href="edit-billing.blade.php" class="btn btn-sm bg-success-light">
																	<i class="fas fa-edit"></i> Edit
																</a>
																<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																	<i class="far fa-trash-alt"></i> Delete
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0008</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0007</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0006</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0005</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0004</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0003</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0002</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
													...
													<tr>
														<td>
															<a href="invoice-view.blade.php">#INV-0001</a>
														</td>
														<td>
															<h2 class="table-avatar">
																<a href="doctor-profile.blade.php" class="avatar avatar-sm mr-2">
																...
																<a href="doctor-profile.blade.php">Dr. Olga Barlow <span>#0010</span></a>
															</h2>
														</td>
														<td>$550</td>
														<td>5 Nov 2019</td>
