...
<!-- doccure/privacy-policy.blade.php  30 Nov 2019 04:12:34 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doccure</title>
			...
			<header class="header">
				<nav class="navbar navbar-expand-lg header-nav">
					<div class="navbar-header">
						...
						<a href="index-2.blade.php" class="navbar-brand logo">
							<img src="assets/img/logo.png" class="img-fluid" alt="Logo">
						</a>
					</div>
					<div class="main-menu-wrapper">
						<div class="menu-header">
							<a href="index-2.blade.php" class="menu-logo">
								<img src="assets/img/logo.png" class="img-fluid" alt="Logo">
							</a>
						...
						<ul class="main-nav">
							<li>
								<a href="index-2.blade.php">Home</a>
							</li>
							<li class="has-submenu">
								<a href="#">Doctors <i class="fas fa-chevron-down"></i></a>
								<ul class="submenu">
									<li><a href="doctor-dashboard.blade.php">Doctor Dashboard</a></li>
									<li><a href="appointments.blade.php">Appointments</a></li>
									<li><a href="schedule-timings.blade.php">Schedule Timing</a></li>
									<li><a href="my-patients.blade.php">Patients List</a></li>
									<li><a href="patient-profile.blade.php">Patients Profile</a></li>
									<li><a href="chat-doctor.blade.php">Chat</a></li>
									<li><a href="invoices.blade.php">Invoices</a></li>
									<li><a href="doctor-profile-settings.blade.php">Profile Settings</a></li>
									<li><a href="reviews.blade.php">Reviews</a></li>
									<li><a href="doctor-register.blade.php">Doctor Register</a></li>
								</ul>
							</li>	
							<li class="has-submenu">
								<a href="#">Patients <i class="fas fa-chevron-down"></i></a>
								<ul class="submenu">
									<li><a href="search.blade.php">Search Doctor</a></li>
									<li><a href="doctor-profile.blade.php">Doctor Profile</a></li>
									<li><a href="booking.blade.php">Booking</a></li>
									<li><a href="checkout.blade.php">Checkout</a></li>
									<li><a href="booking-success.blade.php">Booking Success</a></li>
									<li><a href="patient-dashboard.blade.php">Patient Dashboard</a></li>
									<li><a href="favourites.blade.php">Favourites</a></li>
							...
							<li class="has-submenu">
								...
								<ul class="submenu">
									<li><a href="voice-call.blade.php">Voice Call</a></li>
									<li><a href="video-call.blade.php">Video Call</a></li>
									<li><a href="search.blade.php">Search Doctors</a></li>
									<li><a href="calendar.blade.php">Calendar</a></li>
									<li><a href="components.blade.php">Components</a></li>
									<li class="has-submenu">
										<a href="invoices.blade.php">Invoices</a>
										<ul class="submenu">
											<li><a href="invoices.blade.php">Invoices</a></li>
											<li><a href="invoice-view.blade.php">Invoice View</a></li>
										</ul>
									</li>
									<li><a href="blank-page.blade.php">Starter Page</a></li>
									<li><a href="login.blade.php">Login</a></li>
									<li><a href="register.blade.php">Register</a></li>
									<li><a href="forgot-password.blade.php">Forgot Password</a></li>
								</ul>
							</li>
							<li>
							...
							<li class="login-link">
								<a href="login.blade.php">Login / Signup</a>
							</li>
						</ul>	 
					</div>		 
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item">
							<a class="nav-link header-login" href="login.blade.php">login / Signup </a>
						</li>
					</ul>
				</nav>
			</header>
					...
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="index-2.blade.php">Home</a></li>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										<li><a href="search.blade.php"><i class="fas fa-angle-double-right"></i> Search for Doctors</a></li>
										<li><a href="login.blade.php"><i class="fas fa-angle-double-right"></i> Login</a></li>
										<li><a href="register.blade.php"><i class="fas fa-angle-double-right"></i> Register</a></li>
										<li><a href="booking.blade.php"><i class="fas fa-angle-double-right"></i> Booking</a></li>
										<li><a href="patient-dashboard.blade.php"><i class="fas fa-angle-double-right"></i> Patient Dashboard</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul>
										<li><a href="appointments.blade.php"><i class="fas fa-angle-double-right"></i> Appointments</a></li>
										<li><a href="chat.blade.php"><i class="fas fa-angle-double-right"></i> Chat</a></li>
										<li><a href="login.blade.php"><i class="fas fa-angle-double-right"></i> Login</a></li>
										<li><a href="doctor-register.blade.php"><i class="fas fa-angle-double-right"></i> Register</a></li>
										<li><a href="doctor-dashboard.blade.php"><i class="fas fa-angle-double-right"></i> Doctor Dashboard</a></li>
									</ul>
								</div>
								<!-- /Footer Widget -->
								...
								<div class="col-md-6 col-lg-6">
									...
									<div class="copyright-menu">
										<ul class="policy-menu">
											<li><a href="term-condition.blade.php">Terms and Conditions</a></li>
											<li><a href="privacy-policy.blade.php">Policy</a></li>
										</ul>
									</div>
									<!-- /Copyright Menu -->
