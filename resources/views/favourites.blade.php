					...
					<div class="row row-grid">
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Ruby Perrin</a>
									...
									<div class="row row-sm">
										<div class="col-6">
											<a href="doctor-profile.blade.php" class="btn view-btn">View Profile</a>
										</div>
										<div class="col-6">
											<a href="booking.blade.php" class="btn book-btn">Book Now</a>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Darren Elder</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Deborah Angel</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Sofia Brient</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Marvin Campbell</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Katharine Berthold</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Linda Tobin</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Paul Richard</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Dr. John Gibbs</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
									<p class="speciality">MDS - Periodontology and Oral Implantology, BDS</p>
									<div class="rating">
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Dr. Olga Barlow</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
									<p class="speciality">MDS - Periodontology and Oral Implantology, BDS</p>
									<div class="rating">
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Dr. Julia Washington</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
						...
						<div class="col-md-6 col-lg-4 col-xl-3">
							<div class="profile-widget">
								...
								<div class="pro-content">
									<h3 class="title">
										<a href="doctor-profile.blade.php">Dr. Shaun Aponte</a>
										<i class="fas fa-check-circle verified"></i>
									</h3>
